...
// Controlador del CRUD de clientes empresariales. Todos los endpoints requieren un token JWT valido (configurado en SecurityConfig)
@RestController
...
public class CustomerController {
    ...
    // Desactiva un cliente (borrado logico): cambia su estado a INACTIVE y devuelve el cliente actualizado
    @DeleteMapping("/{id}")
